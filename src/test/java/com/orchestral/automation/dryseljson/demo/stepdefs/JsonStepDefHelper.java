...
public class JsonStepDefHelper {

	private final JsonTestScriptExecutor jsonTestExecutor;

	public JsonStepDefHelper() {
		this.jsonTestExecutor = new JsonTestScriptExecutor(SeleniumDriverFactory.getWebDriver());
	}

	public JsonTestScriptExecutor getTestExecutor() {
		return this.jsonTestExecutor;
	}
